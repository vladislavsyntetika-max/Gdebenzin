...
async def on_start(message, command: CommandObject):
    ...
    text = (
        "⛽ <b>ГДЕ БЕНЗИН!?</b>\n"
        "<i>От водителя водителю. Знай, где есть — до того как повернёшь.</i>\n\n"
        "Навигатор покажет, <b>где</b> заправка. Но не покажет, <b>есть</b> ли там топливо прямо сейчас. "
        "Эту информацию знают только те, кто там был.\n\n"
        "Тебе нужно знать сейчас — тебе и помогают. Ты отметил — помог другому.\n\n"
        "<b>10 секунд:</b>\n"
        "1. Выбери сеть или открой карту.\n"
        "2. Тапни станцию.\n"
        "3. ✅ Есть · ❌ Нет.\n\n"
        "За отчёты — баллы и звания. За разведку — бонус +5. "
        "За добавление новой АЗС — +50. За исправленную неточность — +20.\n\n"
        "<b>Твоё:</b> /профиль · /топ · /правила · /проблема"
    )
